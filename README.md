...
## dbt_bqcost
This repo contains the base code to help you start to build out your dbt-bqcost adapter plugin, for more information on how to build out the adapter please follow the [docs](https://docs.getdbt.com/docs/contributing/building-a-new-adapter)
...
- If one doesn't exist feel free to request a #db-dbt_bqcost channel be made in the [#channel-requests](https://getdbt.slack.com/archives/C01D8J8AJDA) on dbt community slack channel.
